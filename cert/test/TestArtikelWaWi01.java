...
public class TestArtikelWaWi01 {
	...
	private String[] nichtErlaubteMethoden = { "setNr", "setKurzbezeichnung",
			"setLagerbestand" };
	private String[] geforderteMethoden = { "getNummer", "getBezeichnung",
			"getKurzbezeichnung", "getLagerbestand", "setBezeichnung",
			"einlagern", "auslagern" };
	...
	public void testeKurzbezeichnung() {
		...
		testStrings.put(new Artikel(62873408, "Schlosschraube", 1.),
				"SCHLSSCH3408A");
		...
		testStrings.put(new Artikel(1, "axa", 1.), "X00019");
		testStrings.put(new Artikel(1, "AAAAAAAAAABCEFGHJKLMNPQRSTVWXYZ", 1.),
				"BCFGHJKL0001C");
		testStrings.put(new Artikel(1, "aaaaaaaaaabcefghjklmnpqrstvwxyz", 1.),
				"BCFGHJKL0001C");
		testStrings.put(new Artikel(1, "!\"$%.,+-&/()=?BCEFGHJK", 1.),
				"BCFGHJK00010");
	...
	public void testToString() {
		...
		for (Artikel a : testStrings.keySet()) {
			...
			a.einlagern(10);
			String korrekt = "" + a.getNummer() + ", " + testStrings.get(a)
