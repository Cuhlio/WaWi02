...
public class ArtikelTestWaWi01 {

	private String[] nichtErlaubteMethoden = {"setNr", "setKurzbezeichnung", "setLagerbestand"};
	private String[] geforderteMethoden = {"getNummer", "getBezeichnung", "getKurzbezeichnung", "getLagerbestand", "setBezeichnung", "einlagern", "auslagern"};
	...
	public void testeKurzbezeichnung() {
		...
		testStrings.put(new Artikel(123, "Torx-Schrauben 6x35", 1.), "TRXSCHRB01236");
		testStrings.put(new Artikel(8, "Spax 8x55", 1.), "SPX8X550008D");
		testStrings.put(new Artikel(62873408, "Schlosschraube", 1.), "SCHLSSCH3408A");
		testStrings.put(new Artikel(1, "A", 1.), "00011");
		testStrings.put(new Artikel(1, "a", 1.), "00011");
		testStrings.put(new Artikel(12, "a", 1.), "00123");
		testStrings.put(new Artikel(123, "a", 1.), "01236");
		testStrings.put(new Artikel(1234, "a", 1.), "1234A");
		testStrings.put(new Artikel(12345, "a", 1.), "2345E");
		testStrings.put(new Artikel(123456, "a", 1.), "34562");
		testStrings.put(new Artikel(1, "", 1.), "00011");
		testStrings.put(new Artikel(1, "X", 1.), "X00019");
		testStrings.put(new Artikel(1, "x", 1.), "X00019");
		testStrings.put(new Artikel(1, "XAX", 1.), "XX00011");
		testStrings.put(new Artikel(1, "xax", 1.), "XX00011");
		testStrings.put(new Artikel(1, "AXA", 1.), "X00019");
		testStrings.put(new Artikel(1, "axa", 1.), "X00019");
		testStrings.put(new Artikel(1, "AAAAAAAAAABCEFGHJKLMNPQRSTVWXYZ", 1.), "BCFGHJKL0001C");
		testStrings.put(new Artikel(1, "aaaaaaaaaabcefghjklmnpqrstvwxyz", 1.), "BCFGHJKL0001C");
		testStrings.put(new Artikel(1, "!\"$%.,+-&/()=?BCEFGHJK", 1.), "BCFGHJK00010");
		testStrings.put(new Artikel(2109, "0987654321", 1.), "0987654321096");

		// Methode erzeugeKurzbezeichnung testen
		for(Artikel a : testStrings.keySet()){
			assertEquals("Falsche Kurzbezeichnung zu geg. (Lang-)Bezeichnung bei direktem Test von erzeugeKurzbezeichnung", testStrings.get(a), Artikel.erzeugeKurzbezeichnung(a.getNummer(), a.getBezeichnung()));
		}
		...
		for(Artikel a : testStrings.keySet()){
			...
			assertEquals("setBezeichnung(...) muss auch Kurzbezeichnung veraendern", Artikel.erzeugeKurzbezeichnung(last.getNummer(), a.getBezeichnung()), last.getKurzbezeichnung());
			last=a;
		}
	...
	public void testToString(){
		...
		for(Artikel a : testStrings.keySet()){
			...
			a.einlagern(10);
			String korrekt = "" + a.getNummer() + ", " + testStrings.get(a) + ", " + a.getBezeichnung()+ ", " + a.getLagerbestand() + " auf Lager";
